 ...
 * 采集file_manager的日志
 */
public class TailFileManageSource extends AbstractSource implements Configurable,
        PollableSource {
    private Logger LOG = LoggerFactory.getLogger(TailFileManageSource.class);
    private List<Event> eventList = new ArrayList<Event>();

    private String logFilePath = "";
    private String fileNamePrefix = "fileMgr_log";

    private String hiddenFileName = "_file_manager_collect_map";
                    ...
                    for(File logFile:files){
                        ...
                        if(fileCountsMap.containsKey(fileName)){
                            ...
                            while ((tmp = randomFile.readLine()) != null) {
                                count++;
                                if (tmp.contains("Successed to upload file")&&tmp.contains("size")) {
